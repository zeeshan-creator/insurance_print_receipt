...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">{{ __('Users') }} /</span> {{ __('All') }}
    </h4>

    <div class="card">
        <div class="">
            <h5 class="card-header float-start">{{ __('User') }}</h5>
            <a href="{{ route('users.create') }}" class="btn btn-secondary m-3 text-white float-end">{{ __('Add') }}</a>
        </div>
