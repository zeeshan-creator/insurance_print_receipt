...
(function () {
  ...
  $.ajax({
    ...
    .done(function (data) {
      ...
      // Total Revenue Report Chart - Bar Chart
      // --------------------------------------------------------------------
      const basicLineChartEl = document.querySelector('#YearlyCustomerCount'),
        basicLineChartOptions = {
          series: [{
            name: "Customers",
            data: userCount
          ...
          title: {
            text: 'Customers creation by month',
            align: 'left'
          },
          grid: {
            row: {
  ...
  $.ajax({
    ...
    .done(function (data) {
      ...
      data.forEach(function (entry) {
        let values = Object.values(entry);
        adminCount.push(values[0]);
      });


      // Total Revenue Report Chart - Bar Chart
      // --------------------------------------------------------------------
      const basicLineChartEl = document.querySelector('#YearlyAdminCount'),
        basicLineChartOptions = {
          series: [{
            name: "Admin",
            data: adminCount
