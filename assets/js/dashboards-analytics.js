...
(function () {
  ...
  $.ajax({
    ...
    .done(function (data) {
      ...
      data.forEach(function (entry) {
        let values = Object.values(entry);
        newsCount.push(values[0]);
      });


      // Total Revenue Report Chart - Bar Chart
      // --------------------------------------------------------------------
      const basicLineChartEl = document.querySelector('#YearlyNewsCount'),
        basicLineChartOptions = {
          series: [{
            name: "News",
            data: newsCount
  ...
  $.ajax({
    ...
    .done(function (data) {
      ...
      // Total Revenue Report Chart - Bar Chart
      // --------------------------------------------------------------------
      const basicLineChartEl = document.querySelector('#YearlyPromotionCount'),
        basicLineChartOptions = {
          series: [{
            name: "Users",
            data: promotionCount
          ...
          title: {
            text: 'Promotions Count by month',
            align: 'left'
          },
          grid: {
            row: {
